...
<div id="photoCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img src="Images/IMG_6099.JPG" class="d-block w-100" alt="Photo 1">
   
   <div class="photo-caption">
   <p>Piazza Gae Auilenti | Milano, Italy (October, 2024)</p>
   </div>
   </div>


    <div class="carousel-item">
      <img src="Images/sienna.jpg" class="d-block w-100" alt="Photo 2">
    
    <div class="photo-caption">
   <p>Cattedrale di Siena | Sienna, Italy (November, 2024)</p>
   </div>
    </div>

    <div class="carousel-item">
      <img src="Images/Acet_Summ.JPG" class="d-block w-100" alt="Photo 3">
...
<div class="carousel-item">
      <img src="Images/marakesh.jpg" class="d-block w-100" alt="Photo 4">
    
        <div class="photo-caption">
   <p>Streets of Marakesh | Marakesh, Morocco (December, 2024)</p>
   </div>
...
I believe immersing myself in different cultures, languages, & beliefs in crucial to my understanding of the world. It's incredibly eye-opening as I've come to realize early in my life how much of a privilege it is to call the United States my home. 
